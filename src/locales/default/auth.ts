export default {
  ...
  'betterAuth.wechatProof.back': 'Return to AskCore',
  ...
  'betterAuth.wechatMobile.errors.WECHAT_MOBILE_RATE_LIMITED':
    'Too many attempts were made. Wait briefly, then try again.',
