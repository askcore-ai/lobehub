export default {
  ...
  'agent.welcome.footer':
    'Configure your AskCore AI Agent. It lives on your server, learns from every interaction, and becomes more powerful the longer it runs.',
  ...
  'back': 'Back',
  'finish': 'Get Started',
  'interests.area.business': 'Business',
  'interests.area.coding': 'Coding',
  'interests.area.creator': 'Creator Economy',
  'interests.area.design': 'Design',
  'interests.area.education': 'Education',
  'interests.area.english': '英语',
  'interests.area.finance-legal': 'Finance & Legal',
  'interests.area.highSchool': '高中',
  'interests.area.health': 'Health',
  'interests.area.hobbies': 'Hobbies',
  'interests.area.hr': 'HR',
  'interests.area.investing': 'Investing',
  'interests.area.marketing': 'Marketing',
  'interests.area.math': '数学',
  'interests.area.middleSchool': '初中',
  'interests.area.operations': 'Operations',
  'interests.area.other': 'Other Fields',
  'interests.area.parenting': 'Parenting',
  'interests.area.personal': 'Personal',
  'interests.area.physics': '物理',
  'interests.area.primarySchool': '小学',
  'interests.area.product': 'Product',
  'interests.area.sales': 'Sales',
  'interests.area.writing': 'Writing',
