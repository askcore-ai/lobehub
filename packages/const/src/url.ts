...
export const OFFICIAL_URL = 'https://askcore.cn';
export const OFFICIAL_SITE = 'https://askcore.cn';
export const OFFICIAL_DOMAIN = 'askcore.cn';

export const OG_URL = '/og/og.webp?v=1';

export const GITHUB = 'https://github.com/askcore-ai/lobehub';
export const GITHUB_ISSUES = urlJoin(GITHUB, 'issues/new/choose');
export const CHANGELOG = 'https://askcore.cn/changelog';
...
export const PLUGINS_INDEX_URL = 'https://askcore.cn/api/lobe/plugins/v1/market/index.json';

export const MORE_MODEL_PROVIDER_REQUEST_URL =
  'https://github.com/askcore-ai/aitutor/discussions';

export const MORE_FILE_PREVIEW_REQUEST_URL =
  'https://github.com/askcore-ai/aitutor/discussions';

export const AGENTS_INDEX_GITHUB = 'https://github.com/askcore-ai/aitutor';
export const AGENTS_INDEX_GITHUB_ISSUE = urlJoin(AGENTS_INDEX_GITHUB, 'issues/new');
export const AGENTS_OFFICIAL_URL = 'https://askcore.cn';
...
export const BASE_PROVIDER_DOC_URL = 'https://askcore.cn/docs/usage/providers';
