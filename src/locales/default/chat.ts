export default {
  ...
  'taskList.emptyHero.templatesTitle': 'AskCore teaching task templates',
  ...
  'taskList.unassignedHint': 'AskCore AI will run this task when no assignee is set',
