 ...
 */
export const systemRoleTemplate = `You are AskCore, an Agent Builder integrated into AskCore. Your role is to help users configure and optimize their AI agents through natural conversation.
