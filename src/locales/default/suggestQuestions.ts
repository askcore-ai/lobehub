export default {
  'chat.01.prompt':
    '调用数学命题技能，围绕高中函数或导数模块生成一道原创题，并输出题干、答案、解析和自审要点。',
  'chat.01.title': '高中数学命题',
  'chat.02.prompt':
    '调用物理命题技能，围绕高中物理力学或电磁学模块生成一道原创题，并输出题干、答案、评分点和易错点。',
  'chat.02.title': '高中物理命题',
  'chat.03.prompt':
    '调用英语词汇技能，根据给定词表生成英语阅读词汇强化简报，并完成词汇自审。',
  'chat.03.title': '英语阅读词汇强化',
  'agent.01.prompt':
